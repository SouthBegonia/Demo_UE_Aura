...
void AAuraCharacterBase::InitializeSavedGameAttributes(ULoadScreenSaveGame& SaveGame)
{
	UAuraAbilitySystemLibrary::InitializeDefaultAttributesFromSaveData(this, AbilitySystemComponent, &SaveGame);
}
